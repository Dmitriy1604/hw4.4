...
import com.example.demo.exception.AvatarNotFoundException;
import com.example.demo.exception.FileIsTooBigException;
...
public class AvatarService {
    ...
    public void uploadAvatar(Long studentId, MultipartFile file) throws IOException {
        ...
        student.setAvatar(avatarRepository.save(avatar));
        avatarRepository.save(avatar);
    }

    public Avatar findStudentAvatar(Long studentId) {
        logger.debug("Calling method findStudentAvatar (studentId = {})", studentId);
        Avatar avatar = (Avatar) avatarRepository.findByStudentId(studentId).orElse(null);
        if (avatar == null) {
